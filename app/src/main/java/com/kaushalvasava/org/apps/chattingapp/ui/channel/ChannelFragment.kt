package com.kaushalvasava.org.apps.chattingapp.ui.channel
...
import com.kaushalvasava.org.apps.chattingapp.databinding.FragmentChannelBinding
...
class ChannelFragment : Fragment() {
    ...
    private fun setupUser() {
        if (client.getCurrentUser() == null) {
            user = if (args.chatUser.firstName.contains("Kaushal")) {
                User(
                ...
                client.updateUser(newUser)
                    .enqueue { result ->
                        if (result.isSuccess) {
                            ...
                            headerAvatar.setUserData(newUser)
                            Log.d("ChannelFragment", "Success Connecting the User")
                        } else {
                            Log.d("ChannelFragment", result.error().message.toString())
                        }
